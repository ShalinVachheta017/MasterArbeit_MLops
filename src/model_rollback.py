    ...
    def rollback(self, target_version: Optional[str] = None) -> bool:
        ...
        if target_version is None:
            ...
            if target_version is None:
                ...
                archived = [
                    v for v, info in self.registry['models'].items()
...
def main():
    parser = argparse.ArgumentParser(
        description='Model rollback manager for HAR MLOps pipeline'
    )
    
    parser.add_argument('--list', action='store_true',
                       help='List all model versions')
    parser.add_argument('--current', action='store_true',
                       help='Show current deployed version')
    ...
    parser.add_argument('--register', type=str, default=None,
                       help='Register a new model (path to model file)')
    parser.add_argument('--deploy', type=str, default=None,
                       help='Deploy a specific version')
