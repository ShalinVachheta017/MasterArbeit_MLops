...
class TestDataValidation:
    ...
    def test_accelerometer_range(self, sample_sensor_data):
        ...
        for col in accel_cols:
            ...
            assert max_val < max_reasonable_accel, f"Column {col} has unreasonable value: {max_val}"
    ...
    def test_gyroscope_range(self, sample_sensor_data):
        ...
        for col in gyro_cols:
            max_val = sample_sensor_data[col].abs().max()
            assert max_val < max_reasonable_gyro, f"Column {col} has unreasonable value: {max_val}"
...
class TestDataQuality:
    ...
    def test_variance_not_collapsed(self, sample_sensor_data):
        ...
        for col in sensor_cols:
            ...
            assert variance > min_variance, f"Column {col} has collapsed variance: {variance}"
    ...
    def test_sufficient_data_points(self, sample_sensor_data):
        ...
        assert (
            len(sample_sensor_data) >= min_samples
