...
class TestMetricsExporter:
    ...
    def test_record_prediction(self):
        ...
        exporter.record_prediction(activity_class=0, confidence=0.95, latency_seconds=0.05)
    ...
    def test_export_prometheus_format(self):
        ...
        exporter.record_batch_metrics(
            mean_confidence=0.85, mean_entropy=0.4, flip_rate=0.1, processing_time=1.5, n_samples=50
        )
