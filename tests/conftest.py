...
def sample_predictions():
    ...
    return {"probabilities": probs, "predictions": predictions, "confidence": confidence}
...
def sample_monitoring_report():
    ...
    return {
        ...
        "temporal_report": {
            "metrics": {"flip_rate": 0.18, "mean_dwell_time_seconds": 3.5, "short_dwell_ratio": 0.1}
        },
        "drift_report": {
            "per_channel_metrics": {
...
def mock_model_config():
    ...
    return {"window_size": 200, "n_sensors": 6, "n_classes": 11, "input_shape": (200, 6)}
